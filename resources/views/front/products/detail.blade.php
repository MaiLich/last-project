                    ...
                    <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                        <a href="{{ asset('front/images/product_images/large/' . $productDetails['product_image']) }}">
                            <img src="{{ asset('front/images/product_images/large/' . $productDetails['product_image']) }}"
                                alt="{{ $productDetails['product_name'] }}" width="500" height="500" />
                        </a>
                    </div>
                    ...
                    <div class="thumbnails" style="margin-top: 30px">
                        <a href="{{ asset('front/images/product_images/large/' . $productDetails['product_image']) }}"
                            ...
                            <img src="{{ asset('front/images/product_images/small/' . $productDetails['product_image']) }}"
                                width="120" height="120" alt="{{ $productDetails['product_name'] }}" />
                        </a>
                        ...
                        @foreach ($productDetails['images'] as $image)
                            <a href="{{ asset('front/images/product_images/large/' . $image['image']) }}"
                                ...
                                <img src="{{ asset('front/images/product_images/small/' . $image['image']) }}" width="120"
                                    height="120" alt="{{ $productDetails['product_name'] }}" />
                            </a>
                        @endforeach
                    </div>
                </div>
                        ...
                        <form action="{{ url('cart/add') }}" method="Post" class="post-form">
                                ...
                                <div class="sizes u-s-m-b-11" style="margin-top: 20px">
                                    ...
                                    <div class="size-variant select-box-wrapper">
                                        <select class="select-box product-size" id="getPrice"
                                            product-id="{{ $productDetails['id'] }}" name="size" required>
                            ...
                            <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                                ...
                                <div>
                                    ...
                                    <button class="button button-outline-secondary far fa-heart u-s-m-l-6"
                                        title="Yêu thích"></button>
                                    <button class="button button-outline-secondary far fa-envelope u-s-m-l-6"
                    ...
                    <div class="detail-tabs-wrapper u-s-p-t-80">
                        <div class="detail-nav-wrapper u-s-m-b-30">
                            <ul class="nav single-product-nav justify-content-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#review">Đánh giá
                                        ({{ count($ratings) }})</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="row r-1 u-s-m-b-26 u-s-p-b-22">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="total-star-meter">
                                                <div class="star-wrapper"><span>5
                                                        sao</span><span>({{ $ratingFiveStarCount }})</span></div>
                                                <div class="star-wrapper"><span>4
                                                        sao</span><span>({{ $ratingFourStarCount }})</span></div>
                                                <div class="star-wrapper"><span>3
                                                        sao</span><span>({{ $ratingThreeStarCount }})</span></div>
                                                <div class="star-wrapper"><span>2
                                                        sao</span><span>({{ $ratingTwoStarCount }})</span></div>
                                                <div class="star-wrapper"><span>1
                                                        sao</span><span>({{ $ratingOneStarCount }})</span></div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="review-data">
                                                        <div class="reviewer-name-and-date">
                                                            ...
                                                            <h6 class="review-posted-date">
                                                                {{ date('d/m/Y H:i', strtotime($rating['created_at'])) }}</h6>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="policy">
                                <div class="description-whole-container">
                                    ...
                                    <ul style="line-height: 1.8;">
                                        <li>- Mức phí: <strong>30,000₫ nội thành</strong> và <strong>40,000₫ ngoại
                                                thành</strong></li>
