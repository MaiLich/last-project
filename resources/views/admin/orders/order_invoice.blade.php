        ...
        <div class="col-xs-12">
            <div class="invoice-title">
                ...
                <h3 class="pull-right">
                    ...
                    {{-- gói tạo mã vạch): https://github.com/milon/barcode --}}
                    @php
                        echo DNS1D::getBarcodeHTML($orderDetails['id'], 'C39');       //  `id` Barcode
                        // echo DNS2D::getBarcodeHTML($orderDetails['id'], 'QRCODE'); // `id` QR code
                    @endphp
                </h3>
            </div>
            <hr>
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        <td>
                                            ...
                                            @php
                                                echo DNS1D::getBarcodeHTML($product['product_code'], 'C39');       //  `product_code` Barcode
                                                // echo DNS2D::getBarcodeHTML($product['product_code'], 'QRCODE'); // `product_code` QR code
                                            @endphp
                                        </td>
                                        <td class="text-center">{{ $product['product_size'] }}</td>
                                        <td class="text-center">{{ $product['product_color'] }}</td>
                                        <td class="text-center">{{ $product['product_price'] }}đ</td>
                                        <td class="text-center">{{ $product['product_qty'] }}</td>
                                        <td class="text-right"> {{ $product['product_price'] * $product['product_qty'] }}đ
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="thick-line text-right">{{ $subTotal }}đ</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="no-line text-right">
                                        <strong>{{ $orderDetails['grand_total'] }}đ</strong>
                                        <br>
