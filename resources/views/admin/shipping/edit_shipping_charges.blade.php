                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/edit-shipping-charges/' . $shippingDetails['id']) }}" method="post"> <!-- If the id is not passed in from the route, this measn 'Add a new Shipping Charge', but if the id is passed in from the route, this means 'Edit the Shipping Charge' --> <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="0_500g" placeholder="Nhập phí vận chuyển" name="0_500g" value="{{ $shippingDetails['0_500g'] }}"> 
                                </div>
                                <div class="form-group">
                                    <label for="501g_1000g">Phí (501g-1000g)</label>
                                    <input type="text" class="form-control" id="501g_1000g" placeholder="Nhập phí vận chuyển" name="501g_1000g" value="{{ $shippingDetails['501g_1000g'] }}"> 
                                </div>
                                <div class="form-group">
                                    <label for="1001_2000g">Phí (1001-2000g)</label>
                                    <input type="text" class="form-control" id="1001_2000g" placeholder="Nhập phí vận chuyển" name="1001_2000g" value="{{ $shippingDetails['1001_2000g'] }}"> 
                                </div>
                                <div class="form-group">
                                    <label for="2001g_5000g">Phí (2001g-5000g)</label>
                                    <input type="text" class="form-control" id="2001g_5000g" placeholder="Nhập phí vận chuyển" name="2001g_5000g" value="{{ $shippingDetails['2001g_5000g'] }}"> 
                                </div>
                                <div class="form-group">
                                    <label for="above_5000g">Phí (Trên 5000g)</label>
                                    <input type="text" class="form-control" id="above_5000g" placeholder="Nhập phí vận chuyển" name="above_5000g" value="{{ $shippingDetails['above_5000g'] }}"> 
                                </div>
